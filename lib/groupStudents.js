 ...
 * @param {{ groupByNext?: boolean }} [options]
 */
 ...
 * @param {{ groupByNext?: boolean }} [options] When true, group by next rank belt (for grading PDFs).
...
export function applyFilters(
  students,
  { search = "", beltFilter = "all", stripeFilters = [] } = {}
) {
 ...
 * @param {'adults'|'kids'} category
 */
export function beltCounts(students, category) {
  const groups = groupByBelt(students, category, "date");
