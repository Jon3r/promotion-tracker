 ...
 * @property {number|null} [memberStyleId] ClubWorx member_styles.id when synced from API
 * @property {string|null} [gradingBeltOverride] Local override for grading list / PDF grouping
 ...
 * @property {boolean} [readyToPromote] ClubWorx "ready to promote" indicator
